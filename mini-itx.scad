...
module traditional(show_body, show_lid, show_internals, heatsink_type, psu_type) {
    ...
    case_origin = [motherboard_back_edge-wall, -20, -miniitx_bottom_keepout-wall]; // TODO: Clean up the Y calculation
    ...
    case_size = [max(miniitx_cooling_length, 0), miniitx[1]-case_origin[1]+motherboard_back_panel_overhang+motherboard_back_panel_lip, max(psu_heatsink_stack, gpu_stack)];
...
traditional(show_body = false, show_lid = true, show_internals = false, heatsink_type = "aio", psu_type = "sfx");
